...
type AdminView = "home" | "claims" | "operators" | "finance" | "properties" | "users" | "audit" | "notifications";

/* ---------- sidebar config ---------- */
const SIDEBAR_BASE: { id: AdminView; icon: keyof typeof I; label: string }[] = [
          ...
          <nav className="space-y-0.5">
            {SIDEBAR_BASE.map((item) => {
              ...
              <button
                ...
                className={`w-full flex items-center gap-x-3 px-4 py-2.5 rounded-xl text-sm font-medium cursor-pointer border-none text-left transition-colors ${
